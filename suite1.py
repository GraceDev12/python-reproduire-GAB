...
from suite2 import traiter_montant
...
class Application:
    def __init__(self, fenetre):
        ...
        texte1 = tk.Label(self.carre_bleu, text="Entrez votre code", font=("Helvetica", 16), fg="white", bg="blue")
        texte1.place(relx=0.5, rely=0.4, anchor="center")
        # Champ pour entrer les nombres
        self.champ_nombre = tk.Entry(self.carre_bleu, font=("Helvetica", 14), show= "*")
    ...
    def ajouter_nombre(self):
        ...
        if client_trouve:
            ...
            call(["python", "suite2.py"])
        else:
            print("Client non trouvé")
            call(["python", "non_trouve.py"])
