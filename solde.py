...
class Application:
    def __init__(self, fenetre):
        ...
        texte1 = tk.Label(self.carre_bleu, text="Votre solde est de 80000", font=("Helvetica", 16), fg="white", bg="blue")
        texte1.place(relx=0.48, rely=0.28, anchor="center")
        texte2 = tk.Label(self.carre_bleu, text="Retirer de l'argent", font=("Helvetica", 16), fg="white", bg="blue")
        texte2.place(relx=0.70, rely=0.53, anchor="center")
        texte3 = tk.Label(self.carre_bleu, text="Quitter", font=("Helvetica", 16), fg="white", bg="blue")
        ...
        print('hhu')
        bouton2 = tk.Button(fenetre, text="<", bg="white", fg="black", font=("Helvetica", 14), command=self.retirer)
        bouton2.place(relx=0.7, rely=0.28, anchor="center")
        bouton4 = tk.Button(fenetre, text="<", bg="white", fg="black", font=("Helvetica", 14),command=self.termine)
