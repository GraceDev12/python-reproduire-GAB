...
class Application:
    def __init__(self, fenetre):
        ...
        texte2.place(relx=0.85, rely=0.53, anchor="center")
        ...
        bouton3 = tk.Button(fenetre, text="-----------------", bg="white", fg="black", font=("Helvetica", 14), command=self.carte)
