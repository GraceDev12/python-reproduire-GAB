...
class Application:
    def __init__(self, fenetre):
        ...
        texte1 = tk.Label(self.carre_bleu, text="Voulez vous un tiquet ?", font=("Helvetica", 16), fg="white", bg="blue")
        texte1.place(relx=0.48, rely=0.28, anchor="center")
        texte2 = tk.Label(self.carre_bleu, text="Oui", font=("Helvetica", 16), fg="white", bg="blue")
        ...
        bouton2 = tk.Button(fenetre, text="<", bg="white", fg="black", font=("Helvetica", 14), command=self.oui)
        ...
        texte2_d = tk.Label(self.carre_bleu, text="Non", font=("Helvetica", 16), fg="white", bg="blue")
        ...
        bouton2_d = tk.Button(fenetre, text=">", bg="white", fg="black", font=("Helvetica", 14), command=self.non)
