...
class Application:
    def __init__(self, fenetre):
        ...
        texte1 = tk.Label(self.carre_bleu, text="Retirer de l'argent", font=("Helvetica", 16), fg="white", bg="blue")
        texte1.place(relx=0.69, rely=0.25, anchor="center")
        texte2 = tk.Label(self.carre_bleu, text="Consulter le solde", font=("Helvetica", 16), fg="white", bg="blue")
        texte2.place(relx=0.69, rely=0.53, anchor="center")
        texte3 = tk.Label(self.carre_bleu, text="", font=("Helvetica", 16), fg="white", bg="blue")
        texte3.place(relx=0.69, rely=0.75, anchor="center")
        bouton1 = tk.Button(fenetre, text="<", bg="white", fg="black", font=("Helvetica", 14), command=self.retirer)
        bouton1.place(relx=0.7, rely=0.14, anchor="center")
        bouton2 = tk.Button(fenetre, text="<", bg="white", fg="black", font=("Helvetica", 14), command=self.consulter)
        ...
        texte2_d.place(relx=0.14, rely=0.53, anchor="center")
    ...
    def retirer(self):
        ...
        call(["python", "suite3.py"])

    def consulter(self):
        self.fenetre.destroy()
        call(["python", "suite4.py"])
